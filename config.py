...
class Config:
    def __init__(self, website: str) -> None:
        ...
        self.model = ChatAnthropic(model_name="claude-3-5-haiku-latest", temperature=0.2, rate_limiter=self.rate_limiter)
        self.advanced_model = ChatAnthropic(
            model_name="claude-3-5-haiku-latest", temperature=0.2, rate_limiter=self.rate_limiter
        )
